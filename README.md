...
|--------|------|-------------|
| **1** | `plot1_total_actuals_vs_budget.png` | Total Budget vs Actuals by Department (bar) |
...
| Plot 1 | Plot 2 |
|--------|--------|
| ![Plot 1](plot1_total_actuals_vs_budget.png) | ![Plot 2](plot2_avg_variance_bar_chart.png) |
...
- `plot1_total_actuals_vs_budget.png`
